...
<body bgcolor="silver">
	...
	<div>
		<h2 id="hed1">
			...
			<a href="./home">Home&emsp;&ensp;</a> <a href="./draft">Draft&emsp;&ensp;</a>
			<a href="./newmail">New Mail&emsp;&ensp;</a>
		</h2>
	</div>
	<hr>
	<% List<SentMailBean> res= (List<SentMailBean>) request.getAttribute("sent"); %>
	<%for(int i=0;i<res.size();i++){%>
	<h4>To :&emsp;<%= res.get(i).getToemail() %></h4>
